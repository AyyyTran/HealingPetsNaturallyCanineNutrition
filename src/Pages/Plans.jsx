  ...
  return (
    <div className="bg-primary py-4">
      ...
      <div className="p-4 md:grid md:grid-cols-3">
        <div className="bg-grey rounded-xl p-4 w-3/4 md:w-4/5 mx-auto my-2 flex flex-col justify-between shadow-xl transition ease-in-out hover:-translate-y-0.5 hover:scale-105">
